            ...
            <div className={`flex items-start justify-between bg-transparent lg:h-full lg:w-full `}>
                <div className="flex items-center mt-3 ml-2 sm:mr-20 sm:mt-0 lg:mr-40">
                  <Link to="/">
                    <img 
                      src={Logo} 
                      alt='Logo' 
                      className="absolute transform scale-[2] sm:scale-[1.5] lg:scale-[2.5] lg:ml-5 object-cover sm:object-fill lg:h-40 lg:mb-20 lg:mt-2"
                      onClick={() => {setOnHomePage(true)}}>
                    </img>
                  </Link>
                </div>
                
                <div className="absolute top-0 z-10 text-3xl text-white lg:text-5xl sm:text-4xl pt-9 right-7 lg:mr-8 lg:right-20 sm:right-10 md:pt-10 lg:pt-12">
                ...
                <div className={`flex flex-row-reverse z-0 items-center gap-7 text-[10px] pt-10 pr-20 sm:gap-10 lg:gap-20 sm:text-sm md:text-lg lg:text-2xl nav-links lg:pt-14 lg:pr-52 sm:pr-28 md:pt-10 md:gap-16 sm:mt-0 transition duration-500 ${menuOpen ? 'visible opacity-100' : 'invisible opacity-0'}`}>
                    ...
                    <Link to="/about-us" className="relative group">
                      <button 
                      className="z-10 text-white font-Italiana hover:text-black focus:text-gray-300"
                      onClick={() => setOnHomePage(false)}>About Us</button>
                    </Link>
                </div>
              </div>
              </div>
